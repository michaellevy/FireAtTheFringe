...
Shifting dynamics (e.g., climate change) between interacting social and ecological systems can intensify previously benign phenomena or create novel threats to both humans and the natural environment [@Moritz2014; @Paveglio2011]. For example, in recent decades, the southern California region, has experienced increasing frequency of and threat of losses from wildfire [@CALFIRE2000; @Keeley1999; @Syphard2007a], which is attributable to both social processes-i.e., urban expansion and the patterns of residential development coupled with forest management and fire suppression-and ecological conditions-i.e., seasonal weather events, topography, and climate change (Syphard et al., 2005, 2007a, 2007b, 2008).
